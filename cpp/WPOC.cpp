...
#define WM_SHOWMAINWINDOW (WM_USER + 100)
    ...
    L"NetTrack已在后台运行",         // Chinese
    L"NetTrack is running in background", // English
    L"NetTrackはバックグラウンドで動作中です", // Japanese
    L"NetTrack이(가) 백그라운드에서 실행 중입니다", // Korean
    L"NetTrack fonctionne en arrière-plan", // French
    L"NetTrack läuft im Hintergrund", // German
    L"NetTrack работает в фоновом режиме", // Russian
    L"NetTrack se está ejecutando en segundo plano" // Spanish
            };
